...
public class Main {
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradeprecreate15599861595074480623";
    ...
    public void test_trade_precreate() {
        ...
        String subject = "xxx影城xxx影院xxx电影当面付扫码消费";
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("C:\\tmp/qr-%s.png",
