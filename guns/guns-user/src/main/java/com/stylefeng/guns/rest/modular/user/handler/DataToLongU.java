 ...
 */
public class DataToLongU extends BaseTypeHandler<Long> {
    ...
    @Override
    public Long getNullableResult(ResultSet resultSet, String update_time) throws SQLException {
        String stringData = resultSet.getString("update_time");
